namespace System.Management
{
    ...
    public enum ManagementError : uint 
    {
        ...
        WBEM_E_CRITICAL_ERROR = 0x8004100,
        WBEM_E_INVALID_STREAM = 0x8004100,
        WBEM_E_NOT_SUPPORTED = 0x8004100,
        WBEM_E_INVALID_SUPERCLASS = 0x8004100,
        WBEM_E_INVALID_NAMESPACE = 0x8004100,
        WBEM_E_INVALID_OBJECT = 0x8004100,
        ...
        WBEM_E_OVERRIDE_NOT_ALLOWED = 0x8004101,
        WBEM_E_PROPAGATED_QUALIFIER = 0x8004101,
        WBEM_E_PROPAGATED_PROPERTY = 0x8004101,
        WBEM_E_UNEXPECTED = 0x8004101,
        WBEM_E_ILLEGAL_OPERATION = 0x8004101,
        WBEM_E_CANNOT_BE_KEY = 0x8004101,
        ...
        WBEM_E_INVALID_PROPERTY_TYPE = 0x8004102,
        WBEM_E_VALUE_OUT_OF_RANGE = 0x8004102,
        WBEM_E_CANNOT_BE_SINGLETON = 0x8004102,
        WBEM_E_INVALID_CIM_TYPE = 0x8004102,
        WBEM_E_INVALID_METHOD = 0x8004102,
        WBEM_E_INVALID_METHOD_PARAMETERS = 0x8004102,
        ...
        WBEM_E_INVALID_OBJECT_PATH = 0x8004103,
        WBEM_E_OUT_OF_DISK_SPACE = 0x8004103,
        WBEM_E_BUFFER_TOO_SMALL = 0x8004103,
        WBEM_E_UNSUPPORTED_PUT_EXTENSION = 0x8004103,
        WBEM_E_UNKNOWN_OBJECT_TYPE = 0x8004103,
        WBEM_E_UNKNOWN_PACKET_TYPE = 0x8004103,
        ...
        WBEM_E_MISSING_GROUP_WITHIN = 0x8004105,
        WBEM_E_MISSING_AGGREGATION_LIST = 0x8004105,
        WBEM_E_PROPERTY_NOT_AN_OBJECT = 0x8004105,
        WBEM_E_AGGREGATING_BY_OBJECT = 0x8004105,
        WBEM_E_UNINTERPRETABLE_PROVIDER_QUERY = 0x8004105,
        ...
        WBEM_E_AMBIGUOUS_OPERATION = 0x8004106,
        WBEM_E_QUOTA_VIOLATION = 0x8004106,
        WBEM_E_TRANSACTION_CONFLICT = 0x8004106,
        WBEM_E_FORCED_ROLLBACK = 0x8004106,
        WBEM_E_UNSUPPORTED_LOCALE = 0x8004106,
        ...
        WBEMMOF_E_UNRECOGNIZED_TOKEN = 0x8004400,
        WBEMMOF_E_UNRECOGNIZED_TYPE = 0x8004400,
        WBEMMOF_E_EXPECTED_PROPERTY_NAME = 0x8004400,
        WBEMMOF_E_TYPEDEF_NOT_SUPPORTED = 0x8004400,
        WBEMMOF_E_UNEXPECTED_ALIAS = 0x8004400,
        WBEMMOF_E_UNEXPECTED_ARRAY_INIT = 0x8004400,
        ...
        WBEMMOF_E_CIMTYPE_QUALIFIER = 0x8004401,
        WBEMMOF_E_DUPLICATE_PROPERTY = 0x8004401,
        WBEMMOF_E_INVALID_NAMESPACE_SPECIFICATION = 0x8004401,
        WBEMMOF_E_OUT_OF_RANGE = 0x8004401,
        WBEMMOF_E_INVALID_FILE = 0x8004401,
        WBEMMOF_E_ALIASES_IN_EMBEDDED = 0x8004401,
        ...
        WBEMMOF_E_UNSUPPORTED_CIMV22_QUAL_VALUE = 0x8004402,
        WBEMMOF_E_UNSUPPORTED_CIMV22_DATA_TYPE = 0x8004402,
        WBEMMOF_E_INVALID_DELETEINSTANCE_SYNTAX = 0x8004402,
        WBEMMOF_E_INVALID_QUALIFIER_SYNTAX = 0x8004402,
        WBEMMOF_E_QUALIFIER_USED_OUTSIDE_SCOPE = 0x8004402,
        WBEMMOF_E_ERROR_CREATING_TEMP_FILE = 0x8004402,
